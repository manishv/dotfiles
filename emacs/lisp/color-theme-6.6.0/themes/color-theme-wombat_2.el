...
(defun color-theme-wombat_2 ()
  ...
  (color-theme-install
   '(color-theme-wombat
     ...
     (font-lock-string-face ((t (:italic t :foreground "#e5786d" :slant italic))))
...
;;     (font-lock-variable-name-face ((t (:foreground "darkolivegreen"))))
     ...
     (org-level-3 ((t (:foreground "#e5786d"))))
     (org-level-4 ((t (:foreground "#8ac6f2"))))
     (org-level-5 ((t (:italic t :slant italic :foreground "#95e454"))))
;     (org-todo ((t (:bold t :foreground "#8ac6f2" :weight bold))))
     (org-todo ((t (:bold t :foreground "#ad7fa8" :weight bold))))
