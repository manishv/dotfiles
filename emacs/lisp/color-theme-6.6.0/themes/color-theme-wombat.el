...
(defun color-theme-wombat ()
  ...
  (color-theme-install
   '(color-theme-wombat
     ...
     (default ((t (:stipple nil :background "#242424" :foreground "#ffffff" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :foundry "outline" :family "Courier New"))))
     ...
     (font-lock-string-face ((t ( :foreground "#e5786d" ))))
...
;;     (font-lock-variable-name-face ((t (:foreground "darkolivegreen"))))
     ...
     (elscreen-tab-background-face ((t (:background "grey15"))))
     (elscreen-tab-other-screen-face ((t (:background "dim gray" :foreground "grey70"))))
     (elscreen-tab-current-screen-face ((t (:background "dim gray" :foreground "#8ac6f2" ))))
     (elscreen-tab-control-face ((t (:inherit elscreen-tab-current-screen-face :underline nil))))
     (linum ((t (:foreground "dim gray" :background "#242424"))))
)))
